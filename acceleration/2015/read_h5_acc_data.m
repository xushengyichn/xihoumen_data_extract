...
close all
% 用法示例
h5_filename = 'H:\xihoumen_data\2015\xihoumen2015acc.h5';  % 替换为您的H5文件路径
group_name = '/acc';  % wind组路径
start_time_str = '2015-03-30 23:00:00';  % 起始时间
end_time_str = '2015-04-01 00:01:00';    % 结束时间
sensor_id = 2;  % 选择传感器编号
...
function filtered_data = extract_data_by_time(h5_filename, group_name, start_time_str, end_time_str, sensor_id)
    ...
    for t = time_interval
        ...
        dataset_name = [datestr(t, 'yyyy-mm-dd HH'), '-VIB-ac', num2str(sensor_id)];
